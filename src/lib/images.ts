...
export const images = {
  ...
  destinations: {
    varanasi: {
      featured: "/images/destinations/varanasi/featured.jpg",
      gallery: [
        "/images/destinations/varanasi/featured.jpg",
        "/images/destinations/varanasi/dashashwamedh-ghat.jpg",
        "/images/destinations/varanasi/ganga-aarti.jpg",
      ],
      attractions: {
        temple: "/images/destinations/varanasi/kashi-vishwanath.jpg",
        ghat: "/images/destinations/varanasi/dashashwamedh-ghat.jpg",
        sarnath: "/images/destinations/varanasi/sarnath.jpg",
      },
      experiences: {
        aarti: "/images/destinations/varanasi/ganga-aarti.jpg",
        boat: "/images/destinations/varanasi/boat-sunrise.jpg",
  ...
  properties: {
    wayneManor: {
      featured: "/images/properties/the-wayne-manor/1.png",
      gallery: [
